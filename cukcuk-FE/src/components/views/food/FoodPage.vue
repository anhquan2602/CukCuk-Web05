<template>
      ...
      <div class="content__body">
        <div class="content__body__options">
          <div class="content__body__option">
            <div
              class="content__body__option-left flex flex-items-center boder-bottom"
            >
              <!-- Function table  -->
              ...
              >
                ...
                >
                  <div
                    class="toolbar__button--icon icon-toolbar icon-export icon-16"
                  ></div>
                  <div class="toolbar__button--text">Xuất khẩu</div>
                </div>
              </div>
            </div>
            <!-- end -->
  ...
  >
    <ul class="fix-list">
      ...
      <li class="fix-item" @click="exportExel">
        <div class="toolbar__button--icon icon-toolbar icon-export icon-16"></div>
        <a href="#" class="fix-link">Xuất khẩu</a>
      </li>
    </ul>
  </div>
...
export default {
  ...
  methods: {
    ...
    async exportExel() {
      try {
        const url =
        "https://localhost:7123/api/v1/Foods/export?responseType=blob";
        window.open(url);
      } catch (error) {
